...
ARCH="arch_type"
CONFIG_DIR="configs/template-config/arch_type"
DOCKERFILE="${CONFIG_DIR}/Dockerfile.template"
...
echo "--- Building Docker image for ${ARCH} (Target: linux/arch_type) ---"
...
# Clean up (remove) the temporary container (redirect errors too)
